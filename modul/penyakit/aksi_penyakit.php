...
// Hapus penyakit
  if ($module == 'penyakit' AND $act == 'hapus') {
    mysqli_query($connection,"DELETE FROM penyakit WHERE kode_penyakit='$_GET[id]'");
...
// Input penyakit
  elseif ($module == 'penyakit' AND $act == 'input') {
    ...
    mysqli_query($connection,"INSERT INTO penyakit(
...
// Update penyakit
  elseif ($module == 'penyakit' AND $act == 'update') {
    ...
    if ($fileName) {
      ...
      mysqli_query($connection,"UPDATE penyakit SET
