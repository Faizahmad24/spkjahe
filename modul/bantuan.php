...
<h2 class="page-header">Petunjuk Penggunaan Sistem Pakar</h2>
<div class="nav-tabs-custom">
    ...
    <i class="fa fa-envelope-square"></i> Kontak Admin</button><br><br><br><br><br><br>
                ...
                <div class="panel box box-danger">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
					 ...
					 2. Selanjutnya silahkan cari gejala yang di dapati di lapangan, misal jahe dengan gejala daun menguning.<br>
		 ...
		 <script>
var d = document.getElementById("pakarjahe");
