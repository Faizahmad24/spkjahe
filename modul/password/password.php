<title>Ubah Password - Jahe</title>
<?php
...
/*$passwordbaru1 = 'newPass1';
$passwordbaru2 = 'newPass2';*/
...
if ($data['password'] ==  md5($passwordlama))
{
	if ($passwordbaru1 == $passwordbaru2)
	{
		...
		$query = mysqli_query($connection,"UPDATE admin SET password = '$passwordbaruenkrip' WHERE username = '$user' ");
