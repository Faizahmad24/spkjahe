...
<html><head>
    ...
    <base href="http://localhost/spkjahe/">
	<link rel="icon" href="gambar/admin/gingerman.png">
  ...
  <body id="pakarjahe" class="hold-transition skin-purple-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-font" aria-hidden="true"></i>Faiz</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-font" aria-hidden="true"></i>Faiz V1.0</b></span>
        </a>
        <!-- Header Navbar -->
                ...
                if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                       <img src="gambar/admin/admin2.png" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?> 
                      <span class="hidden-xs"><?php echo $user; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                       <img src="gambar/admin/admin2.png" class="img-circle" alt="User Image"> 
                        <p>
                      ...
                      <li class="user-footer"> 
                        ...
                        <div class="pull-right">
                          <a class="btn btn-default btn-flat" href="JavaScript: confirmIt('Anda yakin akan logout dari aplikasi ?','logout.php','','','','u','n','Self','Self')" onMouseOver="self.status = ''; return true" onMouseOut="self.status = ''; return true"><i class="fa fa-sign-out"></i> <span>Log Out</span></a>
                        </div>
                      </li>
                    </ul>
                  </li>
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2019 - Made with <i class="fa fa-heart pulse"></i> by <a href="https://www.instagram.com/faizahmad_24/?hl=id" target="_blank">Ahmad Faiz</a></div></strong>
      </footer>
